...
//  Compile (windows): gcc -o test lexical.c lexical_vector.c lexical_to_str.c test.c
//  Compile (Mac): clang -o test lexical.c lexical_vector.c lexical_to_str.c test.c -I..
//  Execute : ./test
// ============================================================
...
int main(void)
{
    ...
    tester("COS(x)");       // majuscules non reconnues
